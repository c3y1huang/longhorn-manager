...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SampleResourceUsage) DeepCopyInto(out *SampleResourceUsage) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SampleResourceUsage.
func (in *SampleResourceUsage) DeepCopy() *SampleResourceUsage {
	if in == nil {
		return nil
	}
	out := new(SampleResourceUsage)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SampleStatus) DeepCopyInto(out *SampleStatus) {
	*out = *in
	if in.GuaranteedInstanceManagerCPU != nil {
		in, out := &in.GuaranteedInstanceManagerCPU, &out.GuaranteedInstanceManagerCPU
		*out = make(map[InstanceManagerType]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	...
	if in.AverageUsage != nil {
		...
		*out = make(map[InstanceManagerType]SampleWorkload, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SampleWorkload) DeepCopyInto(out *SampleWorkload) {
	*out = *in
	out.All = in.All
	out.One = in.One
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SampleWorkload.
func (in *SampleWorkload) DeepCopy() *SampleWorkload {
	if in == nil {
		return nil
	}
	out := new(SampleWorkload)
	in.DeepCopyInto(out)
	return out
}
