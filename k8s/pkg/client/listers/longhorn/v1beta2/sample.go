...
type SampleLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta2.Sample, err error)
...
// List lists all Samples in the indexer.
func (s *sampleLister) List(selector labels.Selector) (ret []*v1beta2.Sample, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.Sample))
	})
	return ret, err
}
...
type SampleNamespaceLister interface {
	...
	Get(name string) (*v1beta2.Sample, error)
...
// List lists all Samples in the indexer for a given namespace.
func (s sampleNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.Sample, err error) {
...
// Get retrieves the Sample from the indexer for a given namespace and name.
func (s sampleNamespaceLister) Get(name string) (*v1beta2.Sample, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("sample"), name)
	}
	return obj.(*v1beta2.Sample), nil
}
